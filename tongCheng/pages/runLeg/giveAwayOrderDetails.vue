	...
	<view class="page">
		...
		<view class="order_info_box">
			...
			<view class="info_box">
				...
				<view class="text">{{orderInfo.remarks}}</view>
			</view>
			<view class="info_box">
			...
			<view class="info_box">
				<view class="name">重量/体积</view>
				<view class="text">￥{{orderInfo.weightAndTypeStr}}</view>
			</view>
			<view class="info_box">
				<view class="name">取件地址</view>
				<view class="text">{{orderInfo.takeAddress}}</view>
			</view>
			<view class="info_box">
				<view class="name">联系人</view>
				<view class="text">{{orderInfo.takeUserName}}</view>
			</view>
			<view class="info_box">
				<view class="name">取件时间</view>
				<view class="text" @click="onCall(orderInfo.takeUserPhone)">{{orderInfo.takeUserPhone}}</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			pageData() {
				this.$http
					.get('api/mime/v1/order_info_take_send', {
