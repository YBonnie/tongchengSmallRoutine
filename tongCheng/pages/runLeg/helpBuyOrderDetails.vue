<template>
	<view class="page">
		...
		<view class="order_info_box">
			...
			<view class="info_box" v-if="orderInfo.orderData.receiptImg.length > 0">
				<view class="name">商品小票</view>
				<view class="imgs">
					<image v-for="(item,index) of orderInfo.orderData.receiptImg" :key="index" :src="item" @click="onPreviewImage(index,orderInfo.orderData.receiptImg)" mode="aspectFill"></image>
				</view>
			</view>
			<view class="dashed_line"></view>
			<view class="size_info_box">
				<view class="name">小费</view>
				<view class="text">￥{{orderInfo.orderData.priceTip}}</view>
			</view>
			<view class="size_info_box">
				<view class="name">跑腿服务费</view>
				<view class="text">￥{{orderInfo.orderData.priceService}}</view>
			</view>
			<view class="size_info_box">
				<view class="name">商品购物费</view>
				<view class="text">￥{{orderInfo.orderData.priceShopping}}</view>
			</view>
			<view class="size_info_box">
		...
		<view class="order_info_box">
			...
			<view class="info_box">
				...
				<view class="text">{{orderInfo.goodsDesc}}</view>
			</view>
			<view class="info_box" v-if="orderInfo.goodsImg.length > 0">
				<view class="name">参考图片</view>
				<view class="imgs">
					<image v-for="(item,index) of orderInfo.goodsImg" :key="index" :src="item" @click="onPreviewImage(index,orderInfo.goodsImg)" mode="aspectFill"></image>
				</view>
			</view>
			<view class="info_box">
				<view class="name">预估费用</view>
				<view class="text">￥{{orderInfo.priceGoods}}</view>
			</view>
			<view class="info_box">
				<view class="name">购买地址</view>
				<view class="text">{{orderInfo.addressBuy}}</view>
			</view>
			<view class="info_box">
				<view class="name">期望时间</view>
				<view class="text">{{orderInfo.deliveryTimeStr}}</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			pageData() {
				this.$http
					.get('api/mime/v1/order_info_buy', {
