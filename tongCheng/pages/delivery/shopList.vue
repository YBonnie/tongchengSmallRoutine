<template>
	<view class="shop_list_box">
		...
		<!-- 商家列表 -->
		<view class="shop_list" v-if="shopsLists.length > 0"><shop-item v-for="(item, index) of shopsLists" :key="index" :item="item"  type="delivery"></shop-item></view>
