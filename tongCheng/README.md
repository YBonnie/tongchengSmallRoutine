#发布备注
1:显示或隐藏示头部：App.vue
2.1:显示或隐藏底部tab：page.json(一般不要提交)
{
	"pagePath": "pages/repast/repast",
	"iconPath": "static/icon/tab/icon_diancan.png",
	"selectedIconPath": "static/icon/tab/icon_diancan_c.png",
	"text": "点餐"
},
2.2:把需要默认显示的页面放第一位
3:项目请求配置：config/baseUrl.js
4:登录用户token: config/store.js
5:版本配置：manifest.json
# website
